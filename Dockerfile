...
RUN apt-get update && \
    ...
    apt-get install -y binutils ca-certificates curl dbus fonts-noto-cjk locales openbox patch supervisor tigervnc-standalone-server tigervnc-tools tzdata unzip --no-install-recommends && \
...
RUN curl -fL# https://site-assets.fontawesome.com/releases/v6.0.0/svgs/solid/cloud-arrow-down.svg -o /usr/share/novnc/app/images/downloads.svg && \
    ...
    ln -s /usr/share/icons/hicolor/256x256/apps/org.nicotine_plus.Nicotine.png /usr/share/novnc/app/images/appicon.png && \
